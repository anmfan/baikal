        ...
        <Group width="fill" direction="horizontal" directionMobile="vertical">
          <Group maxWidth="50%" maxWidthMobile="none">
            <Text
              ...
              tag="p"
            >
              Команда профессионалов BAIKALSEA Company внедрила систему
              стандартов производства и управления, которая подтверждена
            ...
            >
              ...
              стандартами наши специалисты тщательно отбирают материалы и
              проводят аудит производства всех основных Поставщиков,
              осуществляют контроль за качеством продукции на всех этапах. В
              BAIKALSEA Company внедрена система обучения и развития
              сотрудников, основанная на Ценностях Компании.
            </Text>
